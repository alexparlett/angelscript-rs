...
impl<'ast> Registrar<'ast> {
    ...
    fn generate_op_assign(&mut self, qualified_name: &str, type_id: TypeHash) {
        ...
        let func_def = FunctionDef {
            ...
            namespace: self.namespace_path.clone(),
            params: Vec::new(),  // Empty - will be filled in Pass 2a with const ClassName&
            return_type: DataType::simple(primitive_hashes::VOID),  // Will be updated in Pass 2a to ClassName&
            object_type: Some(type_id),
            traits: FunctionTraits {
    ...
    fn visit_virtual_property(&mut self, prop: &crate::ast::VirtualPropertyDecl, type_id: TypeHash) {
            ...
            match accessor.kind {
                PropertyAccessorKind::Get => {
                    ...
                    let func_def = FunctionDef {
                        ...
                        return_type: DataType::simple(primitive_hashes::VOID),  // Will be updated in Pass 2a
                        object_type: Some(type_id),
                        traits: FunctionTraits {
                            is_constructor: false,
                            is_destructor: false,

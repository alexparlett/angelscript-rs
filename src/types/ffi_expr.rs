...
pub trait FfiExprExt {
    ...
    fn from_ast(expr: &crate::ast::Expr<'_>) -> Option<FfiExpr>;
}
...
fn from_literal(kind: &crate::ast::LiteralKind) -> Option<FfiExpr> {
...
mod tests {
    ...
    fn from_ast_unary() {
        use bumpalo::Bump;
        use crate::ast::{Expr, LiteralExpr, LiteralKind, UnaryExpr, UnaryOp};
        use crate::lexer::Span;
    ...
    fn from_ast_binary() {
        use bumpalo::Bump;
        use crate::ast::{BinaryExpr, BinaryOp, Expr, LiteralExpr, LiteralKind};
        use crate::lexer::Span;

...
use crate::ffi::{
    asCreateScriptEngine, asEngine_AddRef, asEngine_ClearMessageCallback, asEngine_CreateContext,
    asEngine_DiscardModule, asEngine_GetEngineProperty, asEngine_GetGlobalFunctionByDecl,
    asEngine_GetGlobalFunctionByIndex, asEngine_GetGlobalFunctionCount,
    asEngine_GetModule, asEngine_GetModuleByIndex, asEngine_GetModuleCount,
    asEngine_GetTypeIdByDecl, asEngine_GetTypeInfoByDecl, asEngine_GetTypeInfoByName,
    asEngine_RegisterGlobalFunction, asEngine_RegisterObjectBehaviour, asEngine_RegisterObjectMethod,
    asEngine_RegisterObjectProperty, asEngine_RegisterObjectType, asEngine_Release,
    asEngine_SetEngineProperty, asEngine_SetMessageCallback, asEngine_ShutDownAndRelease,
    asEngine_WriteMessage, asFUNCTION_t, asGetLibraryOptions, asGetLibraryVersion,
    asIScriptEngine, asSMessageInfo, ANGELSCRIPT_VERSION,
};
...
impl Engine {
    ...
    // Engine properties
    pub fn set_engine_property(&self, property: EngineProp, value: usize) -> Result<()> {
        unsafe { Error::from_code(asEngine_SetEngineProperty(self.engine, property, value)) }
    }

    pub fn get_engine_property(&self, property: EngineProp) -> usize {
    ...
    pub fn set_message_callback(&mut self, callback: MessageCallbackFn) -> Result<()> {
        ...
        unsafe {
            Error::from_code(asEngine_SetMessageCallback(
                ...
                c_func,
                c_self,
                CallConvTypes::asCALL_CDECL as u32,
            ))
        }
    }
    ...
    pub fn register_object_type(
        ...
        unsafe {
            Error::from_code(asEngine_RegisterObjectType(
                ...
                c_name.as_ptr(),
                byte_size as i32,
                flags.iter().fold(0u32, |lhs, b| lhs | *b as u32),
            ))
        }
    }
    ...
    // Modules
    pub fn get_module(&self, name: &str, flag: GMFlags) -> Result<Module> {
        let c_name = CString::new(name)?;
    ...
    pub fn get_module_by_index(&self, index: u32) -> Result<Module> {
        unsafe {
    ...
    pub(crate) fn as_ptr(&self) -> *mut asIScriptEngine {
        self.engine
    }

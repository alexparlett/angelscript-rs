...
pub struct TypeInfo {
    ...
    _phantom: PhantomData<asITypeInfo>,
}
...
impl TypeInfo {
    ...
    pub fn get_engine(&self) -> *mut asIScriptEngine {
        unsafe {
            asTypeInfo_GetEngine(self.type_info)
        }
    }
    ...
    pub fn get_access_mask(&self) -> asDWORD {
        unsafe {
            asTypeInfo_GetAccessMask(self.type_info)
        }
    }
    ...
    pub fn add_ref(&self) -> Result<()> {
        unsafe {
            Error::from_code(asTypeInfo_AddRef(self.type_info))
        }
    }

    pub fn release(&self) -> Result<()> {
        unsafe {
            Error::from_code(asTypeInfo_Release(self.type_info))
        }
    }
    ...
    pub fn derives_from(&self, obj_type: &TypeInfo) -> bool {
        unsafe {
            from_as_bool(asTypeInfo_DerivesFrom(self.type_info, obj_type.type_info))
        }
    }

    pub fn get_flags(&self) -> asDWORD {
        unsafe {
            asTypeInfo_GetFlags(self.type_info)
        }
    }

    pub fn get_size(&self) -> asUINT {
        unsafe {
            asTypeInfo_GetSize(self.type_info)
        }
    }

    pub fn get_type_id(&self) -> i32 {
        unsafe {
            asTypeInfo_GetTypeId(self.type_info)
        }
    }

    pub fn get_sub_type_id(&self, sub_type_index: asUINT) -> i32 {
        unsafe {
            asTypeInfo_GetSubTypeId(self.type_info, sub_type_index)
        }
    }
    ...
    pub fn get_sub_type_count(&self) -> asUINT {
        unsafe {
            asTypeInfo_GetSubTypeCount(self.type_info)
        }
    }
    ...
    pub fn get_interface_count(&self) -> asUINT {
        unsafe {
            asTypeInfo_GetInterfaceCount(self.type_info)
        }
    }
    ...
    pub fn implements(&self, obj_type: &TypeInfo) -> bool {
        unsafe {
            from_as_bool(asTypeInfo_Implements(self.type_info, obj_type.type_info))
        }
    }
    ...
    pub fn get_factory_count(&self) -> asUINT {
        unsafe {
            asTypeInfo_GetFactoryCount(self.type_info)
        }
    }
    ...
    pub fn get_method_count(&self) -> asUINT {
        unsafe {
            asTypeInfo_GetMethodCount(self.type_info)
        }
    }
    ...
    pub fn get_method_by_name(&self, name: &str, get_virtual: bool) -> Result<Function> {
        ...
        unsafe {
            let func = asTypeInfo_GetMethodByName(self.type_info, c_name.as_ptr(), as_bool(get_virtual));
            if func.is_null() {
                Err(Error::NoFunction)
            } else {
                Ok(Function::from_raw(func))
    ...
    pub fn get_method_by_decl(&self, decl: &str, get_virtual: bool) -> Result<Function> {
        ...
        unsafe {
            let func = asTypeInfo_GetMethodByDecl(self.type_info, c_decl.as_ptr(), as_bool(get_virtual));
            if func.is_null() {
                Err(Error::NoFunction)
            } else {
                Ok(Function::from_raw(func))
    ...
    pub fn get_property_count(&self) -> asUINT {
        unsafe {
            asTypeInfo_GetPropertyCount(self.type_info)
        }
    }

    pub fn get_property(&self, index: asUINT) -> Result<PropertyInfo> {
    ...
    pub fn get_property_declaration(&self, index: asUINT, include_namespace: bool) -> Option<&str> {
        unsafe {
            let decl = asTypeInfo_GetPropertyDeclaration(self.type_info, index, as_bool(include_namespace));
            if decl.is_null() {
                None
            } else {
    ...
    pub fn get_behaviour_count(&self) -> asUINT {
        unsafe {
            asTypeInfo_GetBehaviourCount(self.type_info)
        }
    }

    pub fn get_behaviour_by_index(&self, index: asEBehaviours) -> Option<(Function, asEBehaviours)> {
        let mut behaviour: asEBehaviours = index;

        unsafe {
            let func = asTypeInfo_GetBehaviourByIndex(self.type_info, index as asUINT, &mut behaviour);
            if func.is_null() {
                None
            } else {
                Some((Function::from_raw(func), behaviour))
            }
        }
    }
    ...
    pub fn get_child_funcdef_count(&self) -> asUINT {
        unsafe {
            asTypeInfo_GetChildFuncdefCount(self.type_info)
        }
    }
    ...
    pub fn get_enum_value_count(&self) -> asUINT {
        unsafe {
            asTypeInfo_GetEnumValueCount(self.type_info)
        }
    }
    ...
    pub fn get_enum_value_by_index(&self, index: asUINT) -> Option<(String, i32)> {
        ...
        unsafe {
            ...
            if name.is_null() {
                ...
                CStr::from_ptr(name).to_str().ok().map(|s| (s.to_string(), out_value))
            }
        }
    }
    ...
    pub fn get_typedef_type_id(&self) -> i32 {
        unsafe {
            asTypeInfo_GetTypedefTypeId(self.type_info)
        }
    }
    ...
    pub fn get_user_data(&self, type_: asPWORD) -> *mut c_void {
        unsafe {
            asTypeInfo_GetUserData(self.type_info, type_)
        }
    }

    pub fn set_user_data(&self, data: *mut c_void, type_: asPWORD) -> *mut c_void {
        unsafe {
            asTypeInfo_SetUserData(self.type_info, data, type_)
        }
    }

    pub fn as_ptr(&self) -> *mut asITypeInfo {
        self.type_info
    }
}

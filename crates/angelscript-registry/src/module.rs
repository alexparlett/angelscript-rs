...
//! let module = Module::new(&["game", "entities"])
//!     .class::<Player>()
//!     .class::<Enemy>()
//!     .function(update_world_meta());
//!
...
impl Module {
    ...
    /// Register a class type using its macro-generated metadata.
    ///
    ...
    /// struct Player { ... }
    ///
    /// let module = Module::new().class::<Player>();
    /// ```
    pub fn class<T: Any + HasClassMeta>(mut self) -> Self {
        self.classes.push(T::__as_type_meta());
        self
    }

    /// Register a class using an explicit ClassMeta.
    ///
    /// Use this when you need to manually construct the metadata.
    pub fn class_meta(mut self, meta: ClassMeta) -> Self {
    ...
    /// fn greet(name: &str) { ... }
    ///
    /// let module = Module::new().function(__as_greet_meta());
    /// ```
    pub fn function(mut self, meta: FunctionMeta) -> Self {
...
mod tests {
    ...
    fn module_with_class_meta() {
        ...
        let module = Module::new().class_meta(meta);
    ...
    fn module_with_function() {
        ...
        let module = Module::new().function(meta);
        assert_eq!(module.len(), 1);
    ...
    fn module_builder_chain() {
        ...
        let module = Module::in_namespace(&["game"])
            .class_meta(player_meta)
            .class_meta(enemy_meta)
    ...
    fn module_direct_field_access() {
        ...
        let module = Module::in_namespace(&["world"])

...
use angelscript_parser::ast::types::{ParamType, PrimitiveType as AstPrimitiveType, TypeBase, TypeExpr, TypeSuffix};
use angelscript_parser::ast::{FunctionParam, FunctionSignatureDecl, RefKind, ReturnType};
use angelscript_core::{primitives as primitive_hashes, DataType, Param, RefModifier, TypeHash};
...
/// Convert an AST FunctionParam to Param.
pub fn function_param_to_ffi(param: &FunctionParam<'_>) -> Param {
